...
<div class="form-group">
  <label class="col-md-4 control-label" for="newBreakTitle">Tytuł</label>  
  <div class="col-md-4">
...
<!-- Select Basic -->
<div class="form-group">
  <label class="col-md-4 control-label" for="newBreakTime">Termin</label>
  <div class="col-md-4">
...
<!-- Button -->
<div class="form-group">
  <label class="col-md-4 control-label" for="newBreakButton"></label>
  <div class="col-md-4">

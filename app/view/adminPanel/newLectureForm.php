...
<div class="form-group">
  <label class="col-md-6 control-label" for="newLectureTitle">Tytuł</label>  
  <div class="col-md-6">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-6 control-label" for="newLectureAbstract">Abstrakt</label>
  <div class="col-md-6">                     
...
<!-- Select Multiple -->
<div class="form-group">
  <label class="col-md-6 control-label" for="newLectureAuthors">Autorzy</label>
  <div class="col-md-6">
...
<!-- Select Basic -->
<div class="form-group">
  <label class="col-md-6 control-label" for="newLectureTime">Termin</label>
  <div class="col-md-6">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-6 control-label" for="newLecturePlace">Miejsce</label>  
  <div class="col-md-6">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-6 control-label" for="newLectureTags">Tagi</label>  
  <div class="col-md-6">
...
<!-- Button -->
<div class="form-group">
  <label class="col-md-6 control-label" for="newLectureButton"></label>
  <div class="col-md-6">
